// This drill involves a series of modifications of a buggy program to turn it from something useless into something
// reasonably useful.
// 1. Take the calculator from the file calculator02buggy.cpp. Get it to compile. You need to find and fix a few bugs.
// Those bugs are not in the text in the book. Find the three logic errors deviously inserted in calculator02buggy.cpp
